 ...
 * @source https://gist.github.com/SlashNephy/eba2e78c4a55dfaef51d8d9a984fff2b
 * @updateUrl https://gist.githubusercontent.com/SlashNephy/eba2e78c4a55dfaef51d8d9a984fff2b/raw/91f9f1d437e7838fa0cbc0b8fec58b4b71eabb65/VoiceChatNotificationsForVoiceroid2Proxy.plugin.js
 */
/*@cc_on
@if (@_jscript)
...
const config = {
	"info": {
		...
		"description": "Modified version of Strencher's VoiceChatNotifications: Supports Voiceroid2Proxy to speak messages via VOICEROID2.",
		"authors": [{
			"name": "Asteria Nocturna",
			"discord_id": "187577389419724800",
			"github_username": "SlashNephy"
		}],
		"github": "https://gist.github.com/SlashNephy/eba2e78c4a55dfaef51d8d9a984fff2b",
		"github_raw": "https://gist.githubusercontent.com/SlashNephy/eba2e78c4a55dfaef51d8d9a984fff2b/raw/91f9f1d437e7838fa0cbc0b8fec58b4b71eabb65/VoiceChatNotificationsForVoiceroid2Proxy.plugin.js"
	},
	"changelog": [{
		"type": "fixed",
		"title": "Fixes",
			...
			818: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
				...
				const constants = {
					VOICE_STATES: {
						deaf: {
							setting: "serverDeaf",
							strings: ["サーバー側スピーカーミュートを解除されました。", "サーバー側スピーカーミュートされました。"],
						...
						VoiceChatNotifications_defineProperty(this, "onVoiceStateChange", (props => {
							for (const update of props.voiceStates) {
								...
								const pushToLog = message => {
									...
									xhr.open("POST", "http://localhost:4532/talk", true);
									xhr.send(JSON.stringify({text: `${user}が${message}`}));
